// modified from grunt-contrib's copy task
...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask("copy_ignore", "Copy files into another directory, optionally ignoring some files.", function() {
    ...
    Object.keys(data.files).forEach(function(dest) {
      ...
      var srcFiles = _.difference(grunt.file.expandFiles(src), grunt.file.expandFiles(options.ignore));
